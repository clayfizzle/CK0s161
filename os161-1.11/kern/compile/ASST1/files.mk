...
threadfun.o: ${S}/main/threadfun.c
	${COMPILE.c} ${S}/main/threadfun.c
SRCS+=${S}/main/threadfun.c
OBJS+=threadfun.o
...
printtest.o: ${S}/test/printtest.c
	${COMPILE.c} ${S}/test/printtest.c
SRCS+=${S}/test/printtest.c
OBJS+=printtest.o
